...
\begin{figure}[!htpb]
	...
	\caption{\textbf{Coupling between.} \underline{Top left:} produces acidification.}
...
\begin{figure}[!htpb]
	...
	\caption{\textbf{Coupling between.} \underline{Top left:} produces acidification. \cite{biorender}.}
	\label{fig:carbon_and_mito_detail}
\end{figure}
\end{lstlisting}
